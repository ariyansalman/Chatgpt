...
from utils.safe_conversation import end_conversation
...
async def maintenance_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    lines = [
        ...
        f"{'🔴 <b>ON</b>' if mode_on else '🟢 <b>OFF</b>'}  ·  Maintenance Mode",
        "",
        f"📝 <b>Message:</b>\n<i>{msg[:200]}</i>",
    ]
    if return_time:
    ...
    kb: List[List[InlineKeyboardButton]] = [
        [InlineKeyboardButton(
            "🔴 Maintenance\nON" if mode_on else "🟢 Maintenance\nOFF",
    ...
    convs.append(CH(
        ...
        states={
            MAINT_MSG: [
                ...
                CQH(end_conversation, pattern=r"^maint:menu$"),
            ],
        },
        fallbacks=[CQH(end_conversation, pattern=r"^maint:menu$")],
    ...
    convs.append(CH(
        ...
        states={
            MAINT_WL_ADD: [
                ...
                CQH(end_conversation, pattern=r"^maint:wl$"),
            ],
        },
        fallbacks=[CQH(end_conversation, pattern=r"^maint:wl$")],
        per_user=True, per_chat=True, allow_reentry=True,
    ))
